...
spec = iu.spec_from_file_location(
    'main', os.path.join(_base, 'testchonggou3.py'))
...
fig.tight_layout()
if True:
    fig.savefig(os.path.join(outdir, 'microboone_spectrum_genie_xE.png'), dpi=150, bbox_inches='tight')
    print(f'[single_plot3] saved to {os.path.join(outdir, "microboone_spectrum_genie_xE.png")}')
