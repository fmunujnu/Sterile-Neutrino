...
class PredictionScaledGaussianLikelihood:
    ...
    def __post_init__(self) -> None:
        ...
        if observed.shape != (104,) or reference.shape != (104,):
            raise ValueError("prediction-scaled BNB likelihood requires 104-bin vectors")
        if systematic.shape != (104, 104):
            raise ValueError("reference systematic covariance must have shape (104, 104)")
