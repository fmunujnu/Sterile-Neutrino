...
class MicroBooNE:
    def __init__(self):
        ...
        self.n_channels         = 2
        self.signal_fractions   = np.array([1.0, 1.0])
...
def plot_bkg_pred_vs_data(exp, rate_calc, model_name, params,
    ...
    # --- 观测数据点（FC + PC 通道之和，无误差棒） ---
    ax.plot(energies, data_sum,
            'o', color='crimson', markersize=7,
            markeredgewidth=1.2,
    ...
    ax.legend(fontsize=11, loc='higher left', framealpha=0.85)
