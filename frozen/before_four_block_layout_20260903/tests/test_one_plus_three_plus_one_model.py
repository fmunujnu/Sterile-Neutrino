...
from sterile_fit.one_plus_three_plus_one.model import OnePlusThreePlusOneVacuumModel
from sterile_fit.one_plus_three_plus_one.parameters import OnePlusThreePlusOneParameters
