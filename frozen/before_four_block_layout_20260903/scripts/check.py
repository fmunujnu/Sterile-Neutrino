...
from sterile_fit.experiments.microboone.bnb.published_inputs import load_bnb_four_channel_inputs
from sterile_fit.experiments.microboone.bnb.workflow import build_strict_bnb_workflow


ROOT = Path(__file__).resolve().parents[1]
REFERENCE_CONFIG = ROOT / "configs" / "experiments" / "microboone" / "bnb" / "analysis.yaml"
BNB_DATA_ROOT = ROOT / "data" / "experiments" / "microboone" / "bnb"
KERNEL_DIRECTORY = BNB_DATA_ROOT / "reweighting"
COVARIANCE_PATH = BNB_DATA_ROOT / "derived" / "bnb_four_channel_total_covariance.csv"
RESPONSE_DIRECTORY = BNB_DATA_ROOT / "derived" / "archival_2022_reco_bnb26_given_true"
